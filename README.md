...
Plan the **safest** bike ride from A to B — not the fastest. Covers Cambridge, Somerville, the inner-ring neighbors (Arlington, Medford, Everett, Belmont, Watertown), riverside Boston (Charlestown, Back Bay, Fenway, Allston/Brighton — its own facility-typed bike network), plus Brookline and Newton. Built for riding
